...
class SchedulingEnv(MultiAgentEnv):
    ...
    def _calculate_osagent_reward(self, agentName, differences) -> float:
        ...
        a, min, max = reward_utils.compute_osagent_reward_tardiness_difference(self.data, self.jobs, self.operations, self.testers,
                                                                  self.configurations, self.prevStateAttributes,
    ...
    def _handle_osagent_action(self, agentName, action) -> None:
        ...
        best_config = obs_utils.compute_best_config_for_operation_on_a_tester(self.data, self.operations, operation,
                                                                              testerName)
        ...
        self.operations[operation][
            'estimatedTestTime'] = obs_utils.compute_estimated_operation_test_time_under_configuration(self.data,
                                                                                                       self.operations[
                                                                                                           operation][
                                                                                                           'opType'],
                                                                                                       self.operations[
    ...
    def _init_internal_state(self, data):
        ...
        for productName, productDetails in data['products']['items'].items():
            ...
            for opNum, opType in enumerate(data['products']['items'][productName]['operations']):
                ...
                in_degree[opNum] = 0
                out_degree[opNum] = 0
                avg_setup_time[opNum] = obs_utils.compute_avg_operation_setup_time(self.data, self.configurations,
                                                                                   opType)
    ...
    def _build_msagent_local_observation_list(self) -> list:
        ...
        return obs_utils.flatten([
            ...
            obs_utils.compute_local_total_setup_plus_test_times(self.data, self.operations, self.configurations,
                                                                self.localBags),
            ...
            obs_utils.compute_local_ratio_of_setup_to_test_time(self.data, self.operations, self.configurations,
                                                                self.localBags)
        ])
    ...
    def _build_osagent_observation(self, localBag, testerName) -> list:
        ...
        return obs_utils.flatten([
            ...
            obs_utils.compute_local_bag_total_setup_plus_test_time(self.data, self.operations, self.configurations,
                                                                   localBag, testerName),
